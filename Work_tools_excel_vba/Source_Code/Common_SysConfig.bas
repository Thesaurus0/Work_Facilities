...
Public Const RANGE_A1 = "A1"    'save the 1st macro file name user input
Public Const RANGE_A2 = "A2"    'save the 2nd macro file name user input
Public Const RANGE_A3 = "A3"    'save the value indicating if the 1st macro file name is already opened
Public Const RANGE_A4 = "A4"    'save the value indicating if the 2nd macro file name is already opened
Public Const RANGE_A5 = "A5"    'save the value indicating if the 1st macro file name is already opened
Public Const RANGE_A6 = "A6"    'save the value indicating if the 2nd macro file name is already opened
